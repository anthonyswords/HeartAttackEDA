...
Hi ha més pacients de gènere masculí que del femení i, a més, han patit menys la diagnosi positiu de la malaltia que el sector femení, segons la distribució anterior.
...
Per últim, crearem udos models supervisats, un de regressió logística i l'altra de Random Forest, per tal de predir les possibilitats d'atac de cor d'un pacient.
